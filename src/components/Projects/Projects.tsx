                ...
                <li className={styles.Projects_cards}>
                  ...
                  >
                    <img
                      src={project.img}
                      alt={project.title}
                      className={styles.Projects_cards_img}
                    />
                    <div className={styles.Projects_cards_flex}>
                      <h1 className={styles.Projects_cards_h1}>
                        {project.title}
                      </h1>
                      <p className={styles.Projects_cards_p}>
                        {project.description}
                      </p>
                      <div className={styles.Projects_cards_a_flex}>
                        <a
                          href={project.deploy}
                          className={styles.Projects_card_a}
                          target="_blank"
                        >
                          <BsLink45Deg className={styles.Projects_card_icons} />
                          Deploy
                        </a>
                        <a
                          href={project.repo}
                          ...
                          target="_blank"
                        >
                          <BsGithub className={styles.Projects_card_icons} />
                          Repositório
                        </a>
                      </div>
                    </div>
